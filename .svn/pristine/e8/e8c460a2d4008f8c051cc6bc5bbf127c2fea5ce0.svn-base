...
@ApiModel(value = "医生常选 疾病国内统一码")
public class DoctorDisease extends BaseJsonObject {
    ...
    public DoctorDisease(Long id, Long userId, Long diseaseCodeId, String diseaseCode, String codeAppend, String diseaseName, String pinyin, String groupPrefix, String shortName, Integer displayOrder, String status, Date gmtCreate, Date gmtModified, String remarks) {
        this.id = id;
        this.userId = userId;
