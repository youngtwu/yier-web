...
@ApiModel(value = "药师送药受理订单表")
public class DrugAcceptOrder extends BaseJsonObject {
    private Long id;
    ...
    private String acceptStatusChanging;

    public String getAcceptStatusChanging() {
        return acceptStatusChanging;
    }

    public void setAcceptStatusChanging(String acceptStatusChanging) {
        this.acceptStatusChanging = acceptStatusChanging;
    }
    ...
    public DrugAcceptOrder(Long id, String sendOrderNo, String acceptOrderNo, String orderNo, String prescriptionId, String medicalPrescriptionId, String pharmacyId, String pharmacyName, String pharmacyAddress, String pharmacyContact, Long patientId, String patientIdCardNo, String patientName, String patientContact, String patientAddressSummary, String patientAddress, String patientSex, String patientYearOld, Long pharmacistId, String pharmacistName, Date planTime, Integer payment, Integer shipPayment, String remind, String other, Date overTime, String overType, String acceptStatus, String status, Date gmtCreate, Date gmtModified, String remarks) {
        this.id = id;
