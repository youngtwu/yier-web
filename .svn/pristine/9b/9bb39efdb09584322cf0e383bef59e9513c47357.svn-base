...
@ApiModel(value = "医生信息表")
public class Doctor extends BaseJsonObject {
    ...
    @ApiModelProperty(value = "医生医生证号")
    private String doctorCardNo;
    @ApiModelProperty(value = "医生手机号")
    private String phoneNumber;
    @ApiModelProperty(value = "医生登陆密码")
    private String passHash;
    @ApiModelProperty(value = "盐值")
    private String passSalt;
    @ApiModelProperty(value = "医生所属医院")
    private Long hospitalId;
    @ApiModelProperty(value = "医生所属科类")
    ...
    @ApiModelProperty(value = "医生职业点")
    private String practicePoint;
    @ApiModelProperty(value = "医生出生日期")
    private Date birthday;
    @ApiModelProperty(value = "性别")
    private String sex;
    @ApiModelProperty(value = "是否开通聊天：0表示开通，1表示没有开通")
    private String chat;
    @ApiModelProperty(value = "上门医疗就诊状态（0开通 1不开通）")
    private String medical;
    @ApiModelProperty(value = "上门就诊医疗价格")
    private Integer medicalPayment;
    @ApiModelProperty(value = "上门就诊每天最多人数")
    ...
    public Doctor(Long id, String trueName, String avatarUrl, String idCardNo, String doctorCardNo, String phoneNumber, String passHash, String passSalt, Long hospitalId, Long catalogId, Long departmentId, Long titleId, String field, Double visit, String practicePoint, Date birthday, String sex, String chat, String medical, Integer medicalPayment, Integer medicalNum, String checkUrl, String photoUrl, String imtoken, String status, Date gmtCreate, Date gmtModified, String remarks, String profile) {
        this.id = id;
    ...
    public  Doctor(Doctor info){
        ...
        this.medicalPayment = info.medicalPayment;
        this.medicalNum = info.medicalNum;
