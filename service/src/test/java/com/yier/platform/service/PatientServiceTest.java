...
public class PatientServiceTest extends TestBase {
    ...
    public void getPatientList() {
        ...
        res.setTotal(count);
        logger.info("获取患者信息列表, 测试结果：{}", res.toJsonString());
    }
    ...
    public void getPatientById() {
        ...
        Patient patient = this.servicePatientService.selectByPrimaryKey(500L);
        res.setData(patient);
        logger.info("根据id获取患者信息, 测试结果：{}", res.toJsonString());
    }
}