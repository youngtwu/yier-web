...
public class PushExample {
    ...
    protected static final String APP_KEY ="ccae_sh";
    protected static final String MASTER_SECRET = "Vv39883371";
...
//        testSendPushWithCallback();
    ...
    public static void testSendPush(String secret,String key,String title,String message,List<String> listPushUserId) {
        ClientConfig clientConfig = ClientConfig.getInstance();
...
//        PushPayload payload = buildPushObject_all_alias_alert();
    ...
    public static PushPayload buildPushObject_android_and_ios(String title,String message,List<String> listPushUserId) {
