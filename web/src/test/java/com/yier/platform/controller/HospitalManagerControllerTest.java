...
//
//@ApiModel(value = "医院信息管理相关的请求接口测试类")
//public class HospitalManagerControllerTest extends TestBase {
//    private static final Logger logger = LoggerFactory.getLogger(HospitalManagerControllerTest.class);
//
//    @Autowired
