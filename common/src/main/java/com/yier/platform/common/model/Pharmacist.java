...
public class Pharmacist extends BaseJsonObject {
    ...
    @ApiModelProperty(value = "平台类型默认是0,如果是系统平台类型是1")
    ...
    public Pharmacist(Long id, String trueName, String avatarUrl, String idCardNo, String doctorCardNo, String phoneNumber, String passHash, String passSalt, Long hospitalId, Long catalogId, Long departmentId, Long pharmacyId, String pharmacyCodeNo, Long titleId, String field, Double visit, String profile, String practicePoint, Date birthday, String sex, String chat, String checkUrl, String photoUrl, String imtoken, Integer platType, String status, Date gmtCreate, Date gmtModified, String remarks) {
        this.id = id;
    ...
    public Pharmacist(Pharmacist info){
        ...
        this.pharmacyId = info.pharmacyId;
        this.pharmacyCodeNo = info.pharmacyCodeNo;
