...
public class Hospital extends BaseJsonObject {
    ...
    private Long id;
    @ApiModelProperty(value = "医院统一code编码")
    ...
    public Hospital(Hospital info) {
        this.id = info.id;
        this.hospitalCodeNo = info.hospitalCodeNo;
        this.name = info.name;
